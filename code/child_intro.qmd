...
This report compares the distribution and relative abundance of `r length(spp)` snailfish species (specifically, `r paste(spp, collapse = ", ")`; @fig-snailfish) with maps from the `r params$report_year` Eastern Bering Sea shelf bottom trawl survey. Survey results reported herein include estimates of catch-per-unit-effort for most snailfishes and geographic distributions (@fig-map-all-spp-2022); @2021NEBS2022; @2018EBS2022; @2019NEBS2022). Data is publicly available from the Fisheries One Stop Shop [@FOSSAFSCData]. 
...
```{r}
#| label: `r paste0('fig-map-all-spp-',params$report_year)
